...
class AIA_Publisher {
    ...
    public function publish_post($post_data) {
        ...
        // ============================================================
        // Get Featured Image from Image Manager
        // ============================================================
    ...
    /**
     * Prepare content - FIXED to properly handle \n without breaking words
     */
    private function prepare_content($content) {
        ...
        // Step 10: Handle the "nn" artifact - ONLY replace "nn" when it appears as a standalone
        // or at the beginning of lines, NOT when it's part of a word
        // Replace "nn" at the start of lines or with spaces around
        $content = preg_replace('/^nn\s*/m', '', $content);
        $content = preg_replace('/\snn\s/', ' ', $content);
        
        // Step 11: Fix "n" followed by newline - this is the problematic part
        // Instead of replacing all "n" with newline, we only replace "n" when it's clearly a newline marker
        // Look for patterns like "\n" or where "n" is at the end of a line
        ...
        // Step 15: Remove any stray "n" characters that might remain
        // This is safe now because we only remove "n" when it's isolated
